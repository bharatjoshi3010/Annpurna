...
const s = StyleSheet.create({
    ...
    menuBtn:         { flex: 1, backgroundColor: Colors.surfaceAlt, borderRadius: 8, paddingVertical: 9, alignItems: 'center' },
...
const ms = StyleSheet.create({
    ...
    closeBtn:         { width: 32, height: 32, borderRadius: 16, backgroundColor: Colors.surfaceAlt, alignItems: 'center', justifyContent: 'center', marginLeft: 8 },
